...
export default function Dashboard() {
    ...
    // State for editing a report title
    ...
    // Initiate edit mode for a report title
        ...
        >
            ...
            <div className="glass" style={{ padding: '2rem', borderRadius: '20px' }}>
                ...
                {loading ? (
                    ...
                    >
                        {reports.map((report) => (
                            <Link to={`/report/${report.$id}`} key={report.$id} style={{ textDecoration: 'none', color: 'inherit' }}>
                                <motion.div variants={itemVariants} className="report-card" style={{ cursor: 'pointer' }}>
                                    <div>
